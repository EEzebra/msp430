...
#define RES_N_0 P2OUT &= 0xEF
#define RES_N_1 P2OUT |= 0x10  //0001 0000 BIT4

//==================================主出从入====================================
#define MOSI_0 P3OUT &= 0x7F
#define MOSI_1 P3OUT |= 0x80  //1000 0000 BIT7
//===================================SPI时钟端口================================
#define SCK_0 P3OUT &= 0xBF
#define SCK_1 P3OUT |= 0x40   //0100 0000 BIT6
//===================================主入从出===================================
#define MISO_0 P3OUT &= 0xDF
#define MISO_1 P3OUT |= 0x20  //0010 0000 BIT5
//=========================GDO2状态=============================================
//#define GDO2_0 P2OUT &=~BIT6
//#define GDO2_1 P2OUT |= BIT6
//==================================SPI使能端口=================================
#define CSN_0 P3OUT &= 0XEF
#define CSN_1 P3OUT |= 0X10   //0001 0000 BIT4
//==========================GDO0状态============================================
